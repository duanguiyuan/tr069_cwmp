...
#define DeviceFrequencyPointModule          "X_CMCC_FrequencyPoint"
#define DeviceBandModule                    "X_CMCC_Band"
#define DeviceCellIdModule                  "X_CMCC_CellId"
#define DevicePhysicsCellIdModule           "X_CMCC_PhysicsCellId"
#define DeviceRSRPModule                    "X_CMCC_RSRP"
#define DeviceRSRQModule                    "X_CMCC_RSRQ"
#define DeviceSINRModule                    "X_CMCC_SINR"
#define DeviceUpstreamTotalByteModule       "X_CMCC_UpstreamTotalByte"
#define DeviceDownstreamTotalByteModule     "X_CMCC_DownstreamTotalByte"
...
struct cwmp_st
{
	...
	int    cpe_PeriodicInformEnable;   /* 心跳开关 */
	int    cpe_PeriodicInformInterval; /* 心跳间隔 */
	long   cpe_time; /* 记录心跳开始 计时的 时间 */
